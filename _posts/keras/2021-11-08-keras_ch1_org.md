...
<img src="https://user-images.githubusercontent.com/78655692/140670247-185274df-d89f-4bd4-baa8-becc452980a0.png" width="650" alt="image"/>
...
- **SVM**은 분류 문제를 해결하기 위해 2개의 다른 범주에 속한 데이터 포인트 그룹 사이에 좋은 결정 경계(decision boundary)를 찾는다.
- **결정 경계**는 훈련 데이터를 2개의 범주에 대응하는 영역으로 나누는 직선이나 표면
