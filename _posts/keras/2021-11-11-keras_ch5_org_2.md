...
categories: keras
tag : [python, keras, DL, ML, AI, 인고지능, 딥러닝, 케라스, CV, 네트워크, 컨브넷, 필터, 시각화]
toc: true
sidebar_main: true
classes: wide
...
- **특성 추출 (Feature extraction)** : <span style="background-color:yellow">사전에 학습된 네트워크의 표현을 사용하여 새로운 샘플에서 흥미로운 특성을 뽑아 내는 것
