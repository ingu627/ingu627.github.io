...
2. 원-핫 인코딩을 사용 <span style="background-color:yellow">=범주형 인코딩(categorical encoding)</span>
...
- 마지막 층이 순수한 선형이므로 <span style="background-color:yellow">네트워크가 어떤 범위의 값이라도 예측하도록 자유롭게 학습된다.</span> 
