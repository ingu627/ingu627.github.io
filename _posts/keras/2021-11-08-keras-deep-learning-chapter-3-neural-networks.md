---
layout: single
title: "케라스 3장: 첫 분류 모델 구축 - 데이터 전처리→훈련→평가"
excerpt: "입력 텐서 준비, 모델 정의(층 스택), 손실·옵티마이저 선택, 훈련·검증 루프와 과적합 신호 확인 절차"
categories: keras
...
redirect_from:
  - /keras/keras_ch3_org/
  - /Chollet_dl/keras_ch3_org_1/
  - /keras/keras_ch3_org_1/
  - /python/keras_ch3_org_1/
---
