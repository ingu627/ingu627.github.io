...
> **우분투 내 SQLite 설치** <br> `$ apt update` <br> `$ apt install sqlite3`  <br><br> `jars sqlite-jdbc-3.39.2.1.jar` 다운로드 명령어 <br> `wget https://github.com/ingu627/BigData/blob/master/sqlite-jdbc-3.39.2.1.jar` [^1]
...
> `postgresql-32.3.7.jar` 다운로드 : `wget https://github.com/ingu627/BigData/blob/master/postgresql-42.3.7.jar` [^2]
