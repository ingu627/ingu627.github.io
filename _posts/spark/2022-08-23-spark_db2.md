...
categories: spark
tag : [스파크, spark, pdf, 빅데이터, 파이썬, python, sql, createOrReplaceTempView, withColumnRenamed, explain, transformation, action, dataframe, directed acyclic graph, dag, 예제, 실습]
toc: true
toc_sticky: true
sidebar_main: true
