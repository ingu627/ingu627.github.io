...
categories: spark
tag : [아파치, apahce, 스파크, spark, pyspark, python, sql, 예제, 실습, 정리, 란, 스칼라, dataset, parquet, 스트리밍, maxFilesPerTrigger, mllib, StringIndexer, OneHotEncoder, VectorAssembler, 머신러닝, rdd, 의미]
toc: true
toc_sticky: true
sidebar_main: true
