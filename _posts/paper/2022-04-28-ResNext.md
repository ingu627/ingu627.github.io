...
categories: paper
tag : [resnext, residual, vggnet, inception, cardinality, depth, 딥러닝, cv, block, 리뷰, 설명, 란, grouped convolution, flops, 논문, 컴퓨티 비전, 정리]
toc: true
toc_sticky: true
sidebar_main: true
...
- (b) : cardinality가 32, depth가 4(=채널수)로 병렬 실행된 후 concatenate하여 1x1 conv 레이어를 연산한다.
