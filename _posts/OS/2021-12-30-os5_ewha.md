...
categories: OS
tag : [OS, 운영체제, 프로세스, 동기화, race condition, synchronization, process, semaphores, deadlock, starvation, monitor, bounded-buffer, readers-writers, dining, philosophers. monitor]
toc: true
toc_sticky: true
sidebar_main: true
