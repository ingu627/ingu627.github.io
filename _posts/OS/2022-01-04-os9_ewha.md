...
categories: OS
tag : [OS, 운영체제, 파일시스템, system, file, directory, access, sequential access, direct access, contiguous allocation linked allocation indexed allocation, free space management, cache, pdf, 정리]
toc: true
toc_sticky: true
sidebar_main: true
