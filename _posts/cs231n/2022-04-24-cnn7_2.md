...
categories: cs231n
tag : [이미지, cnn, cs231n, 리뷰, 정리, 요약, 정의, 란, 딥러닝, 머신러닝, 드롭아웃, dropout, 규제, regularization, data augmentation, dropconnect, max pooling, stochastic depth, cutout, random crop, mixup, hyperparameter, 의미]
toc: true 
toc_sticky: true
sidebar_main: true
