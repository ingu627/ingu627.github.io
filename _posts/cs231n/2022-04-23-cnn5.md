...
categories: cs231n
tag : [cs231n, 리뷰, 정리, 요약, 정의, 란, 딥러닝, 머신러닝, 파이토치, pytorch, 의미, torch.Tensor, torch.autograd, torch.nn.Module, torch.randn, torch.mm, torch.clamp, torch.t, backward, autograd.grad, no_grad, grad.zero_, torch.autograd.Function, forward, ctx, torch.nn.Linear, model.parameters, optimizer.zero_grad]
toc: true 
toc_sticky: true
sidebar_main: true
...
- **optimizer.zero_grad** : 역전파 단계 전에, optimizer 객체를 사용하여 (모델의 학습 가능한 가중치인) 갱신할 변수들에 대한 모든 변화도(gradient)를 0으로 만든다. 이렇게 하는 이유는 기본적으로 .backward()를 호출할 때마다 변화도가 버퍼(buffer)에 (덮어쓰지 않고) 누적되기 때문이다. [^3]
...
- torchvision을 통해 사전 학습된 모델을 매우 쉽게 사용할 수 있다.
...
<img src='https://user-images.githubusercontent.com/78655692/165091543-ee827b22-073a-4199-afbd-3674a922d194.png' width=650>

<img src='https://user-images.githubusercontent.com/78655692/165091647-4cd422fc-b156-4292-8edc-92733d416d3c.png' width=650>

<img src='https://user-images.githubusercontent.com/78655692/165091723-d36d1fa7-34a7-4de7-a514-3f080f3cb300.png' width=650>

<img src='https://user-images.githubusercontent.com/78655692/165091788-2b851ad0-e0f7-483b-8495-27dbcc7c16e1.png' width=650>
