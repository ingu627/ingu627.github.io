...
categories: cs231n
tag : [이미지, 분류, Viewpoint, Background Clutter, Illumination, Occlusion, Deformation, Intraclass variation, data driven approach, nn, knn, l1 거리, l2 거리, 하이퍼파라미터, 교차 검증, cross validation, 선형, cnn, cs231n, 리뷰, 정리, 요약, 정의, 란]
toc: true
toc_sticky: true
sidebar_main: true
