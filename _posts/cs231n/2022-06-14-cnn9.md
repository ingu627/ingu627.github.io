...
categories: cs231n
tag : [이미지, cnn, cs231n, 리뷰, 정리, 요약, 정의, 란, 딥러닝, seq2seq, 컨텍스트, rnn, 인코더, 디코더, attention, seq2seq, image caption, 어텐션, alignment, softmax, context vector, self attention, masked self attention, query, key, value]
toc: true 
toc_sticky: true
sidebar_main: true
...
<img src='https://user-images.githubusercontent.com/78655692/173485334-f8f33b17-051a-41ac-9b98-025a40bca855.gif' width=650>
