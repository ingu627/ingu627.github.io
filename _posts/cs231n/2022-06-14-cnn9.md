---
layout: single
title: "[CS231n] 강의11 Attention and Transformers (1) 리뷰"
...
categories: cs231n
tag : [이미지, cnn, cs231n, 리뷰, 정리, 요약, 정의, 란, 딥러닝, seq2seq, 컨텍스트, rnn, 인코더, 디코더, attention, image caption, 어텐션, alignment, softmax, context vector, positional encoding, self attention, masked self attention, query, key, value, 설명]
toc: true 
toc_sticky: true
sidebar_main: true
...
<img src='https://user-images.githubusercontent.com/78655692/173484195-2920bace-3d52-4dd6-b842-cfd827abcc57.gif' width=650> <br> 이미지출처 [^1]

- 위 그림은 seq2seq를 기계 번역을 할 때이다.

<br>

<img src='https://user-images.githubusercontent.com/78655692/173485334-f8f33b17-051a-41ac-9b98-025a40bca855.gif' width=650> <br> 이미지출처 [^1]
...
<img src='https://user-images.githubusercontent.com/78655692/173479526-39a59ea6-69a0-4ce3-afd0-e36d40d79566.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173501977-92316426-15f2-4413-864e-3766c016fec1.png' width=650>

- 여기까지는 Vanilla RNN의 인코더부분과 똑같다.

<br>

<img src='https://user-images.githubusercontent.com/78655692/173502991-89d80666-55a0-403f-b660-fbaabe54459e.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173512283-4352603f-d823-45ad-9bc2-9bede9db7547.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173515003-4a082c72-0e99-4060-8619-d354b50e3bda.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173517362-fec90852-70a0-403b-b19a-c8230895a64e.png' width=650>

- 위 과정들을 다시 반복하는데, $s_1$을 사용해서 새로운 context vector $c_2$를 계산한다.

<br>

<img src='https://user-images.githubusercontent.com/78655692/173517785-984f6e97-60ad-4672-81ae-a79aec0576f8.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173518178-64472961-e104-4d55-94da-b25a24de4c98.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173542951-cf5e189d-9c2a-43a1-a488-dcdb8ad56ad3.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173556100-21b70237-4dc3-44ea-b2c1-81dd87fb92d9.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173562092-c4ce1c3d-39a1-4c1e-8ed1-647b761e7831.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173563015-d8588fab-6c92-4551-815f-e8d48d35d07f.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173567552-0b02f7b4-dd5a-4a0a-937b-7ca1ced5c499.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173574245-c16a3ac5-891b-4e33-abb3-e3251c03766f.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173578672-5ea2a434-cacc-417c-bf63-3f9e47bc64ae.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173581106-83c2797f-eef9-488e-8e8e-39ea517811d4.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173583812-ed8060d6-1183-4543-a3b9-46eded351fbb.png' width=650>
...
- 각각의 입력 벡터(=토큰)로부터 key vector, value vector, query vector를 생성한다.
  - **query vector** : 토큰에 대한 가중치
  - **key vector** : 토큰이 query와 얼마나 연관되었는지 비교하는 가중치
  - **value vector** : 의미에 대한 가중치
- encoder 과정에서 현재 위치의 토큰을 다른 토큰에 비해 얼마나 집중(attention)해야할지에 대한 점수를 계산한다. 
...
<img src='https://user-images.githubusercontent.com/78655692/173727725-4cca61d4-bb9c-467c-8ea4-2dccd384cb39.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173734052-c457bad1-15fd-4b0f-8ad6-9c03daa8784f.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173587959-97e6eca0-7963-490f-95b5-66866f9ae752.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173589399-8ff5155f-f431-4ece-a6e3-cde24c312a53.png' width=650>
...
<img src='https://user-images.githubusercontent.com/78655692/173589732-a8731c11-944c-4e6f-8aec-6abed5f699ea.png' width=650>
