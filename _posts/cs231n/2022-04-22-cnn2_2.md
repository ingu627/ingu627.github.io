...
categories: cs231n
tag : [이미지, cnn, cs231n, 리뷰, 정리, 요약, 최적화, optimization, loss, 기울기, gradient, 미분, derivative, 편미분, 경사하강법, gradient descent, 수렴, step, sgd, stochastic gradient descent, 정의, 란, 미니배치]
toc: true
toc_sticky: true
sidebar_main: true
