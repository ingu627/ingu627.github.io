---
layout: single
title: "[CS231n] 강의10 Recurrent Neural Networks 리뷰"
excerpt: "본 글은 2022년 4월에 강의한 스탠포드 대학의 Recurrent Neural Networks 2022년 강의를 듣고 정리한 내용입니다. Lecture 10 RNN, LSTM 등이 그 예입니다."
categories: cs231n
tag : [이미지, cnn, cs231n, 리뷰, 정리, 요약, 정의, 란, 딥러닝, Recurrent Neural Network, rnn, many to one, many to many, one to many, image captioning, sequence, 시퀀스, seq2seq, video classifcation, 원리, 설명, multilayer]
toc: true 
toc_sticky: true
sidebar_main: true
...
- 각 timestamp에서 RNN은 입력 프레임 $x_i$와 이전 표현(history) 두개의 인풋을 가진다.
...
- **Cons**
  - 반복 계산(recurrent computation)이 느리다.
